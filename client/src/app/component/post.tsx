      ...
      <div className="flex flex-shrink-0 p-4 pb-0">
            ...
            <div className="pl-16">
                <p className="text-base width-auto font-medium text-white flex-shrink">
                  Day 07 of the challenge <span className="text-purple-400">#100DaysOfCode</span> 
                  I was wondering what I can do with <span className="text-purple-400">#tailwindcss</span>, so just started building Twitter  UI using Tailwind and so far it looks so promising. I will post my code after completion.
                  [07/100]
                  <span className="text-purple-400"> #WomenWhoCode #CodeNewbie</span>
                </p>
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex items-center">
                            <div className="flex-1 text-center">
                                <a href="#" className="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-purple-800 hover:text-purple-300">
